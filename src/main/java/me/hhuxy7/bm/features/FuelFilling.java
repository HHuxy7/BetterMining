...
public class FuelFilling {
    ...
    public void onTick(TickEvent event) {
        if (!BetterMining.config.refuelWithAbiphone || mc.thePlayer == null) return;
    ...
    public void onTickSecond(TickEvent.ClientTickEvent event) {
        ...
        if (!(fuel != -1 && fuel < BetterMining.config.refuelThreshold)) return;
        ...
        switch (currentState) {
            ...
            case WAITING: {
                ...
                if (abiphoneIndex == -1) {
                    ...
                    currentState = states.NONE;
                    BetterMining.config.refuelWithAbiphone = false;
                    Reset();
                    return;
                }
            ...
            case REFILLING_FUEL: {
                ...
                if (mc.thePlayer.openContainer instanceof ContainerChest) {
                    ...
                    switch (BetterMining.config.typeOfFuelIndex) {
                        case 0: {
                            fuelName = "goblin egg";
                            break;
                        }
