...
public class GemstoneMacro extends Macro {
    ...
    public void onTick(TickEvent.Phase phase){
        ...
        if(!haveTreasureChest) {
            switch(baritone.getState()){
                case IDLE:
                    baritone.mineFor(MineUtils.getGemListBasedOnPriority(BetterMining.config.gemGemstoneType));
                    break;
                case FAILED:
    ...
    public void onMessageReceived(String message){
        ...
        if(message.contains("You uncovered a treasure chest!") && BetterMining.config.gemOpenChest){
    ...
    private BaritoneConfig getMineBehaviour(){
        return new BaritoneConfig(
                ...
                true,
                false,
                BetterMining.config.gemRotationTime,
                BetterMining.config.gemRestartTimeThreshold,
                null,
                blocksAllowedToMine,
                BetterMining.config.gemMaxY,
                BetterMining.config.gemMinY
        );
    }
