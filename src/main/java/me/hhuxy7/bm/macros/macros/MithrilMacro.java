...
import me.hhuxy7.bm.mixins.accessors.RenderGlobalAccessor;
...
import me.hhuxy7.bm.utils.HypixelUtils.MineUtils;
...
public class MithrilMacro extends Macro {
    ...
    private ArrayList<ArrayList<BlockData<?>>> getPriorityList() {
        ...
        priorityList.add(MineUtils.getMithrilColorBasedOnPriority(BetterMining.config.mithPriority1));
        priorityList.add(MineUtils.getMithrilColorBasedOnPriority(BetterMining.config.mithPriority2));
        priorityList.add(MineUtils.getMithrilColorBasedOnPriority(BetterMining.config.mithPriority3));
        priorityList.add(MineUtils.getMithrilColorBasedOnPriority(BetterMining.config.mithPriority4));
    ...
    private BaritoneConfig getMineBehaviour() {
        return new BaritoneConfig(
                MiningType.STATIC,
                BetterMining.config.mithShiftWhenMine,
                true,
                false,
                BetterMining.config.mithRotationTime,
                BetterMining.config.mithRestartTimeThreshold,
                null,
                null,
                256,
                0
