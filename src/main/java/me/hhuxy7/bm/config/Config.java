...
import me.hhuxy7.bm.gui.AOTVGemstoneFilter;
import me.hhuxy7.bm.gui.AOTVWaypointsPage;
import me.hhuxy7.bm.hud.MobKillerHUD;
import me.hhuxy7.bm.hud.CommissionMacroHUD;
...
public class Config extends cc.polyfrost.oneconfig.config.Config {
    ...
    public Config() {
        super(new Mod("BetterMining", ModType.HYPIXEL, new VigilanceMigrator("bettermining.toml")), "/bettermining/config.json");
        initialize();
