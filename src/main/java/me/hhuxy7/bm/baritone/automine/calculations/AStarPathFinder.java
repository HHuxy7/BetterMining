package me.hhuxy7.bm.baritone.automine.calculations;

import me.hhuxy7.bm.BetterMining;
import me.hhuxy7.bm.baritone.automine.logging.Logger;
import me.hhuxy7.bm.baritone.automine.calculations.behaviour.PathFinderBehaviour;
import me.hhuxy7.bm.baritone.automine.calculations.behaviour.PathMode;
import me.hhuxy7.bm.baritone.automine.calculations.exceptions.NoBlockException;
import me.hhuxy7.bm.baritone.automine.calculations.exceptions.NoPathException;
import me.hhuxy7.bm.baritone.automine.structures.*;
        ...
        if (MacroHandler.macros.get(0).isEnabled()) {
            ...
            for (BlockNode node : nodes) {
                if (MacroHandler.macros.get(2).isEnabled()) {
                    if (MineUtils.getMithrilColorBasedOnPriority(BetterMining.config.mithPriority4).stream().anyMatch(blockData -> BlockUtils.isBlock(blockData, node.getPos()))) {
                    ...
                    } else if (MineUtils.getMithrilColorBasedOnPriority(BetterMining.config.mithPriority3).stream().anyMatch(blockData -> BlockUtils.isBlock(blockData, node.getPos()))) {
                    ...
                    } else if (MineUtils.getMithrilColorBasedOnPriority(BetterMining.config.mithPriority2).stream().anyMatch(blockData -> BlockUtils.isBlock(blockData, node.getPos()))) {
