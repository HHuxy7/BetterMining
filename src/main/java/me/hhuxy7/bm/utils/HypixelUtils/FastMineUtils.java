...
import me.hhuxy7.bm.macros.macros.GemstoneMacro;
import me.hhuxy7.bm.utils.BlockUtils.BlockUtils;

import me.hhuxy7.bm.utils.InventoryUtils;
...
public class FastMineUtils {
    ...
    public static boolean shouldPreBreakBlock(float miningTicks, float blockDamage) {
        return !MacroHandler.macros.get(1).isEnabled() && BetterMining.config.fastMine && blockDamage < 1f && miningTicks >= getRequiredMiningTicks();
    }
