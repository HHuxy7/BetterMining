...
public class DrawUtils {
    ...
    private static void drawLine(WorldRenderer bufferBuilder, BlockPos pos, BlockPos nextPos) {
        bufferBuilder.pos(pos.getX() + 0.5f, pos.getY() + 0.5f, pos.getZ() + 0.5f).color(BetterMining.config.aotvRouteLineColor.getRed() / 255f, BetterMining.config.aotvRouteLineColor.getGreen() / 255f, BetterMining.config.aotvRouteLineColor.getBlue() / 255f, BetterMining.config.aotvRouteLineColor.getAlpha() / 255f).endVertex();
        bufferBuilder.pos(nextPos.getX() + 0.5f, nextPos.getY() + 0.5f, nextPos.getZ() + 0.5f).color(BetterMining.config.aotvRouteLineColor.getRed() / 255f, BetterMining.config.aotvRouteLineColor.getGreen() / 255f, BetterMining.config.aotvRouteLineColor.getBlue() / 255f, BetterMining.config.aotvRouteLineColor.getAlpha() / 255f).endVertex();
    }

    private static void drawLine(WorldRenderer bufferBuilder, Vec3 pos, Vec3 nextPos) {
        bufferBuilder.pos(pos.xCoord, pos.yCoord, pos.zCoord).color(BetterMining.config.aotvRouteLineColor.getRed() / 255f, BetterMining.config.aotvRouteLineColor.getGreen() / 255f, BetterMining.config.aotvRouteLineColor.getBlue() / 255f, BetterMining.config.aotvRouteLineColor.getAlpha() / 255f).endVertex();
        bufferBuilder.pos(nextPos.xCoord, nextPos.yCoord, nextPos.zCoord).color(BetterMining.config.aotvRouteLineColor.getRed() / 255f, BetterMining.config.aotvRouteLineColor.getGreen() / 255f, BetterMining.config.aotvRouteLineColor.getBlue() / 255f, BetterMining.config.aotvRouteLineColor.getAlpha() / 255f).endVertex();
    }
